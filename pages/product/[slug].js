    ...
    <Layout title={product.name} description={product.description}>
        ...
        <Grid item md={3} xs={12}>
            <List>
                ...
                <ListItem><Typography>Descritpion : {product.description}</Typography></ListItem>
            </List>
        </Grid>
        <Grid item md={3} xs={12}>
            <Card>
                <List>
                    <ListItem>
                        <Grid container>
                            <Grid item xs={6}><Typography>Price : ${product.price}</Typography></Grid>
                            <Grid item xs={6}><Typography>In Stock : {product.stock}</Typography></Grid>
                        </Grid>
                    </ListItem>
                    <ListItem>
                        <Grid container>
